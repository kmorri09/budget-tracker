  ...
  return (
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <div className="sidebar-bottom"><button className="muted-link">⚙ Settings</button><p>Last synced<br /><strong>Today at 9:42 AM</strong></p></div>
      </aside>
