...
export type Entry = { id: string; description: string; amount: number; kind: string; source: string; status: string; pending: boolean; date: string; category: string | null; account: string; accountId: string; paymentStatus: string; remainingToPay: number };
export type CardPayment = { id: string; description: string; amount: number; date: string; fromAccount: string; toAccount: string; applied: number; remaining: number; status: string; covered: string };
