...
export type Obligation = { id: string; name: string; dueDate: string; nextChargeDate: string; amount: number; expectedAmount: number; amountSource: "planned" | "observed"; category: string; categoryId: string; account: string; accountId: string; cadence: string | null; active: boolean; covered: boolean; coveredBy: string | null; lastCharge: { id: string; type: "transaction" | "payment"; date: string; amount: number; description: string; confidence: "automatic" | "confirmed" } | null; previousCharge: { date: string; amount: number } | null; suggestion: { id: string; type: "transaction" | "payment"; date: string; amount: number; description: string; account: string; source: string } | null; dismissedMatches: { id: string; type: "transaction" | "payment"; date: string; amount: number; description: string }[] };
